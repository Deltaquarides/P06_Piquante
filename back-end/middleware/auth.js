...
module.exports = (req, res, next) => {
  try {
    ...
    const decodedToken = jwt.verify(token, "RANDOM_TOKEN_SECRET"); // appel de la méthode vérify qui permet de vérifier la validité d'un token. En lui passant le token récuperer et la clé secrète.
